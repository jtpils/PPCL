...
#         return CropBox(self)
    ...
    def make_ApproximateVoxelGrid_PointXYZI(self):
        ...
        """
        fil = ApproximateVoxelGrid_PointXYZI()
        cdef pclfil.ApproximateVoxelGrid_PointXYZI_t *cfil = <pclfil.ApproximateVoxelGrid_PointXYZI_t *>fil.me
        cfil.setInputCloud(<cpp.shared_ptr[cpp.PointCloud[cpp.PointXYZI]]> self.thisptr_shared)
        return fil
    ...
    def make_EuclideanClusterExtraction(self):
        ...
        cdef pclseg.EuclideanClusterExtraction_PointXYZI_t *cEuclideanClusterExtraction = <pclseg.EuclideanClusterExtraction_PointXYZI_t *>euclideanclusterextraction.me
        cEuclideanClusterExtraction.setInputCloud(<cpp.shared_ptr[cpp.PointCloud[cpp.PointXYZI]]> self.thisptr_shared)
