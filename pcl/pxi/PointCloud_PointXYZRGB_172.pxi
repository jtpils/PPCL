...
#         return octree
    ...
    def make_ApproximateVoxelGrid(self):
        """
        Return a pcl.ApproximateVoxelGrid object with this object set as the input-cloud PointXYZRGB
        """
        fil = ApproximateVoxelGrid_PointXYZRGB()
        cdef pclfil.ApproximateVoxelGrid_PointXYZRGB_t *cfil = <pclfil.ApproximateVoxelGrid_PointXYZRGB_t *>fil.me
        cfil.setInputCloud(<cpp.shared_ptr[cpp.PointCloud[cpp.PointXYZRGB]]> self.thisptr_shared)
        return fil
    ...
    def make_EuclideanClusterExtraction(self):
        ...
        cdef pclseg.EuclideanClusterExtraction_PointXYZRGB_t *cEuclideanClusterExtraction = <pclseg.EuclideanClusterExtraction_PointXYZRGB_t *>euclideanclusterextraction.me
        cEuclideanClusterExtraction.setInputCloud(<cpp.shared_ptr[cpp.PointCloud[cpp.PointXYZRGB]]> self.thisptr_shared)
