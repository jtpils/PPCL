...
#         return octree
    ...
    def make_ApproximateVoxelGrid_PointXYZRGBA(self):
        """
        Return a pcl.ApproximateVoxelGrid object with this object set as the input-cloud PointXYZRGBA
        """
        fil = ApproximateVoxelGrid_PointXYZRGBA()
        cdef pclfil.ApproximateVoxelGrid_PointXYZRGBA_t *cfil = <pclfil.ApproximateVoxelGrid_PointXYZRGBA_t *>fil.me
        cfil.setInputCloud(<cpp.shared_ptr[cpp.PointCloud[cpp.PointXYZRGBA]]> self.thisptr_shared)
        return fil
###
